            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>部门新增</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form  id="modify" class="form-horizontal" action="<%=basePath %>addOrganization" method="post" onsubmit="return check()">
                            <fieldset>

                                <div class="control-group">
                                    <label class="control-label" for="focusedInput">部门名称</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" id="name" type="text" placeholder="部门名称 .." name="name">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="selectError3" name="parentid">
                                                <option value="${Organization.id}">-----无-----</option>
                                            <c:forEach  var="Organization" items="${OrganizationLists}"  >
                                                <option value="${Organization.id}">${Organization.name}</option>
                                            </c:forEach>
                                        </select>
                                        <span><font color="red">* 新增部门为一级部门可不选择</font></span>
                                    </div>
                                </div>
