    ...
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <div class="row-fluid sortable">
                <form action="<%=basePath %>updateOnePduGroup" method="post" onsubmit=" check()">
                    <fieldset>
                    <div class="box span12">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white edit"></i><span class="break"></span>分组编辑</h2>
                            <div class="box-icon">
                                <!--
                        ...
                        <div class="box-content">
                            <div id="tijiao1">
                                <div class="control-group" style="width:50%;float:left;">
                                    <input type="hidden" name="id" value="${pduGroup.id }" />
                                    <label class="control-label" for="focusedInput">分组名称</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" id="groupname" type="text" placeholder="必填"
                                               value="${pduGroup.groupname}" name="groupname">
                                ...
                                <div class="control-group" style="width:49%;float:left;">
                                    ...
                                    <div class="controls">
                                        <input class="input-xlarge focused" id="focusedInput2" type="text" value="${pduGroup.remark}" name="remark">
                                    </div>
                                </div>
                            </div>
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <c:forEach items="${pduList}" var="pdu" varStatus="vs">
                                    <tr>
                                        <td>
                                            <%--<input type="checkbox" value="${pdu.id}"name="pdu">${pdu.id}--%>


                                            <input type="checkbox" name="pdu" value="${pdu.pdu.id}"
                                                   <c:if test="${PduIdList.contains(pdu.pdu.id)}">checked</c:if>
                                            >
                                        </td>
                                        <td>${pdu.pdu.name}</td>
...
<script type="text/javascript">
    ...
    /*function addUser() {
        ...
        form.action = "<%=basePath %>updateOnePduGroup";
        form.method = "post";
        if(check()){
            form.submit();
        }
